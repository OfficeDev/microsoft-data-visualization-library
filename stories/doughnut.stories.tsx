...
import { DoughnutChart, DoughnutChartHighContrast } from "../src/lib/builder";
...
export const Default = () => {
  const config: IChart = new DoughnutChart({
    areaLabel: "Doughnut chart sample",
    data: {
...
export const HighContrast = () => {
  const config: IChart = new DoughnutChartHighContrast({
